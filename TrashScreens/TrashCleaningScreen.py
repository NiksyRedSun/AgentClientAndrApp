...
class TrashCleaningScreen(Screen):
    def __init__(self, **kwargs):
        super(TrashCleaningScreen, self).__init__(**kwargs)
        ...
        self.nickname_label = Label(text="[color=03A062]Претендент[/color]", size_hint=(1, .2),
                                    max_lines=2,
        ...
        self.grid.add_widget(
            Button(text="[color=black]Убрать[/color]", size_hint=(1, .05), font_size=24, font_name="Lucida Console",
                   background_color=(3 / 255, 168 / 255, 98 / 255, 0.8), markup=True, background_normal="",
                   on_press=self.take_out))
